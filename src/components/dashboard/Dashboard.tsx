...
export function Dashboard() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-8 py-6">
      ...
      {loading && (
        <div className="glass-panel p-6 text-white/70">Loading data…</div>
      )}
...
function HeroSection() {
  return (
    <section className="space-y-6">
      <p className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-white/80">
        Celo Proof of Ship
      </p>
...
function BalanceStat({
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
      ...
      <p className={`mt-2 text-4xl font-semibold ${accent}`}>
